...
followup_treatmentRouter.post('/', sanitizeFollowup_treatmentInput, validateTokenAdmin, add);
followup_treatmentRouter.put('/:id', sanitizeFollowup_treatmentInput, validateTokenAdmin, update);
followup_treatmentRouter.patch('/:id', sanitizeFollowup_treatmentInput, validateTokenAdmin, update);
